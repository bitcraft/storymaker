...
def move_action(parent, start, end):
    env = parent.environment
    path = parent.environment.pathfind(start, end)
    path.pop() #starting node returned from pathfinder; don't need it
    while path:
        yield env.set_position(parent, (env, path.pop()))
